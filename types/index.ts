...
export interface Transaction {
  ...
  // Immutable verbatim bank/PSD2 description captured at ingest. Never
  // overwritten by user title edits; source for the dedup bridge and the
  // "restore original" action. Null only for rows predating the column.
