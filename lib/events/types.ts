...
export type CoreEvent =
  ...
  | { type: 'supplier_invoice.uncredited'; payload: { supplierInvoice: SupplierInvoice; deletedCreditNoteId: string; reversalEntryId: string | null; userId: string; companyId: string } }
  // Payment Matching
