...
- **Sociala avgifter age reduction.** Employees under 26 (2024 rule for 2026 birth year ≥ 2001) and over 66 get reduced satser. The engine reads \`employee.birthdate\` and applies the correct sats automatically — don't override unless you've consulted [Skatteverkets table](https://www.skatteverket.se/foretagochorganisationer/skatter/arbetsgivareochinkomstuppgifter/arbetsgivaravgifteroch_skatteavdrag.4.18e1b10334ebe8bc80003392.html).
