  ...
  return (
    <div className="divide-y divide-border">
      ...
      >
        ...
        >
          <SelectTrigger id="invoice_font_family" className="h-9 w-56 rounded-lg">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
      ...
      <SettingsFieldRow
        label={t('ore_rounding_label')}
        description={t('ore_rounding_help')}
      >
        <Switch
      ...
      <SettingsFieldRow label={t('show_ocr_label')} description={t('show_ocr_help')}>
        <Switch
      ...
      <SettingsFieldRow label={t('show_bankgiro_label')} description={t('show_bankgiro_help')}>
        <Switch
      ...
      <SettingsFieldRow label={t('show_plusgiro_label')} description={t('show_plusgiro_help')}>
        <Switch
      ...
      <SettingsFieldRow label={t('show_swish_label')} description={t('show_swish_help')}>
        <Switch
      ...
      <SettingsFieldRow label={t('show_logo_label')} description={t('show_logo_help')}>
        <Switch
      ...
      <SettingsFieldRow
        label={t('show_company_name_label')}
        description={t('show_company_name_help')}
      >
        <Switch
      ...
      {(settings.invoice_show_company_name ?? true) && (
        <SettingsFieldRow label={t('placement_label')}>
          <div
            role="group"
      ...
      <SettingsFieldRow stacked label={t('late_fee_label')} htmlFor="invoice_late_fee_text">
        <Textarea
      ...
      <SettingsFieldRow stacked label={t('credit_terms_label')} htmlFor="invoice_credit_terms_text">
        <Textarea
